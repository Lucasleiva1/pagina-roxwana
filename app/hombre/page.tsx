  ...
  return (
    <>
      <section className="relative min-h-[62svh] overflow-hidden bg-ink pt-32">
        <Image src="/images/products/product-street-rock-001-front-model-desktop.webp" alt="" fill priority sizes="100vw" className="object-cover object-center opacity-68" />
